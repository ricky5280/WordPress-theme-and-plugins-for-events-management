<?php
/*
Plugin Name: Custom database table for newsletter 
Description: plugin for creating database table and manage newsletter
Author: Riccardo
Version: 1.0
*/
...
function custom_table_example_install()
{
    ...
    // récupération du prefix des tables de l'installation    
    ...
    // utilisation de dbDelta pour la migration de la base de données
...
class Custom_Table_Example_List_Table extends WP_List_Table
{
    ...
    {
        global $wpdb;
        $table_name = $wpdb->prefix . 'newsletter'; // do not forget about tables prefix
...
{
    add_menu_page(__('Newsletter', 'custom_table_example'), 
    __('Newsletter', 'custom_table_example'), 
    'activate_plugins', 
    'persons', 
...
/**
    ...
    * [OPTIONAL]
    * additional implementation of register_activation_hook
    * to insert data - new subscriber
    */
    function custom_table_subscription_install_data()
    {
        global $wpdb;
        ...
        if(isset($_POST['submit'])) {
            ...
            if ($result == 1) {
                echo "<script>alert('Adresse email enregistrée'); </script>"; 
            } else {
    ...
    register_activation_hook(__FILE__, 'custom_table_subscription_install_data');
